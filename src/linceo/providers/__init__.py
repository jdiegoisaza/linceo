...
``docs/adr/ADR-000-arquitectura-base-y-alcance-v0.1.md``, §10) — plus the
one reference ``PolicySource`` implementation, ``AzureDevOpsPolicySource``
...
here to ``environment.process_environment`` and, through it,
``azure_devops``'s own resolution; also used directly by callers (such as
